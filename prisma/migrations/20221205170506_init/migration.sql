...
-- AddForeignKey
ALTER TABLE "_JobToTutor" ADD CONSTRAINT "_JobToTutor_A_fkey" FOREIGN KEY ("A") REFERENCES "Job"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_JobToTutor" ADD CONSTRAINT "_JobToTutor_B_fkey" FOREIGN KEY ("B") REFERENCES "Tutor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
